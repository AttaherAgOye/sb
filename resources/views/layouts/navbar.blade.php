<nav class="navbar-premium fixed w-full top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-lg">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
        <div class="flex justify-between items-center h-20">
                ...
                <a href="{{ route('home') }}" class="flex items-center group transition-all duration-300 hover:scale-105">
                    ...
                    <div class="ml-2 md:ml-4">
                        <div class="flex items-baseline gap-1 md:block">
                            <span class="text-base md:text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent whitespace-nowrap">SABOUGNOUMA</span>
                            <span class="text-xs lg:hidden text-gray-600 font-medium">SARL</span>
                        </div>
            ...
            <!-- Menu Desktop -->
            <div class="hidden lg:flex items-center justify-end flex-1 ml-4 space-x-1 xl:space-x-5">
                <a href="{{ route('home') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('home') ? 'active' : '' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    </svg>
                    Accueil
                </a>
                <a href="{{ route('identity') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('identity') ? 'active' : '' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Services Dropdown -->
                <div class="relative">
                    <button id="services-button" class="nav-link whitespace-nowrap flex items-center group">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                        </svg>
                        Services
                        <svg class="w-4 h-4 flex-shrink-0 ml-1 transform group-hover:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    <div id="services-dropdown" class="hidden absolute left-0 mt-3 w-72 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/50 overflow-hidden text-left">
                        <div class="p-2">
                            <a href="{{ route('services.clean') }}" class="service-dropdown-item group">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="font-bold text-blue-600 group-hover:text-blue-700 whitespace-nowrap">SABOU-CLEAN</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Propreté & Entretien</div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('services.event') }}" class="service-dropdown-item group">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="font-bold text-purple-600 group-hover:text-purple-700 whitespace-nowrap">SABOU-EVENT</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Décoration & Événements</div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('services.food') }}" class="service-dropdown-item group">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="font-bold text-orange-600 group-hover:text-orange-700 whitespace-nowrap">SABOU-FOOD</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Restauration & Traiteur</div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('services.agro') }}" class="service-dropdown-item group">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="font-bold text-green-600 group-hover:text-green-700 whitespace-nowrap">SABOU-AGRO</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Agrobusiness</div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('services.academy') }}" class="service-dropdown-item group">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="font-bold text-yellow-600 group-hover:text-yellow-700 whitespace-nowrap">SABOU-ACADEMY</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Formation</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <a href="{{ route('partners') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('partners') ? 'active' : '' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    Partenaires
                </a>
                <a href="{{ route('news') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('news*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>
                    </svg>
                    Actualités
                </a>
                <a href="{{ route('careers') }}" class="nav-link whitespace-nowrap {{ request()->routeIs('careers*') ? 'active' : '' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    Carrières
                </a>
                <a href="{{ route('contact') }}" class="btn-premium whitespace-nowrap flex-shrink-0 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl text-sm font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center">
            ...
            <!-- Mobile menu button -->
            <div class="lg:hidden flex justify-end flex-1 pl-4">
    ...
    <!-- Mobile menu -->
    <div id="mobile-menu" class="hidden lg:hidden bg-white/95 backdrop-blur-md border-t border-gray-200/50 shadow-lg max-h-[85vh] overflow-y-auto">
        <div class="px-4 pt-4 pb-12 space-y-3">
            ...
            <div class="pt-2">
                ...
                <div class="space-y-1 ml-4">
                    <a href="{{ route('services.clean') }}" class="mobile-service-link text-blue-600">
                        <div class="w-6 h-6 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <a href="{{ route('services.event') }}" class="mobile-service-link text-purple-600">
                        <div class="w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 4v10a2 2 0 002 2h6a2 2 0 002-2V8M7 8H5a2 2 0 00-2 2v8a2 2 0 002 2h2m0-12h10m-5 4v4m0 0l-2-2m2 2l2-2"/>
                            </svg>
                        </div>
                    ...
                    <a href="{{ route('services.food') }}" class="mobile-service-link text-orange-600">
                        <div class="w-6 h-6 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                            </svg>
                        </div>
                    ...
                    <a href="{{ route('services.agro') }}" class="mobile-service-link text-green-600">
                        <div class="w-6 h-6 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                            </svg>
                        </div>
                    ...
                    <a href="{{ route('services.academy') }}" class="mobile-service-link text-yellow-600">
                        <div class="w-6 h-6 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                            </svg>
                        </div>
            ...
            <a href="{{ route('careers') }}" class="mobile-nav-link {{ request()->routeIs('careers*') ? 'active' : '' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                Carrières
